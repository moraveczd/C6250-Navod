...
\href{https://docs.google.com/spreadsheets/d/1p3uUhZ6wc6y0mref6gI1PY3qJUGu5aJUVe6hbrzBW0w/edit?usp=sharing}{\emph{Kliknutím na tento text se dostanete do formuláře, kde si můžete zvolit datum konání cvičení.}}
\\
\rule{\textwidth}{2pt}
\\
	Cvičení probíhá v laboratořích A8/1S16 a C12/112. Doba cvičení je 4-5 hodin.
...
\subsection{Protokol}
	...
	\hrule
	\begin{itemize}
		\item Protokol zašlete na adresu hugo@chemi.muni.cz \textit{do dvou týdnů} ode dne konání cvičení.
	\end{itemize}
