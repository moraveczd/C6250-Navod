...
\frame{
	...
	\begin{enumerate}
	\item Krátký úvod k IR spektroskopii (A12/112)
	\item Spuštění spektrometrů, stanovení vlhkosti uvnitř přístroje
	\item Měření IR spekter vzorků v KBr tabletách
	\item Měření IR spekter vzorků metodou ATR
	\item Interpretace IR spekter
	\item Krátký úvod k NMR spektroskopii (A8/1S16)
...
\section{Měření IR spekter vzorků v suspenzi v Nujolu}
\frame{
	\frametitle{}
	\vfill
	Vzorek zakápneme nujolem a důkladně ho v oleji rozsuspendujeme. Suspenzi vložíme mezi KBr tablety a měříme.
	\includegraphics[keepaspectratio,width=10cm]{img/nujol.png}
	\vfill
}

\section{Měření Ramanových spekter vzorků}
\frame{
	\frametitle{}
	\vfill
	Vzorek naplníme do Ramanských kapilár - kapiláry ze speciálního skla o průměru 0,8~mm. Půl hodiny před měřením je nutné začít chladit detektor spektrometru kapalným dusíkem.
	\includegraphics[keepaspectratio,width=10cm]{img/raman.png}
	\vfill
}
